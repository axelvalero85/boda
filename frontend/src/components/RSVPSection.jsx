...
const RSVPSection = () => {
  ...
  return (
    <section id="rsvp" className="py-20 bg-amber-50">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-amber-800 max-w-2xl mx-auto leading-relaxed">
              ...
              antes del <span className="font-medium text-amber-900">{weddingData.rsvp.deadline}</span>
            </p>
          </div>

          {/* Clean Form */}
          <div className="max-w-2xl mx-auto">
            <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-10 border border-amber-200">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      className="h-12 border-amber-300 focus:border-amber-600 focus:ring-amber-600"
                    />
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Select onValueChange={(value) => handleInputChange('attendance', value)}>
                      <SelectTrigger className="h-12 border-amber-300 focus:border-amber-600 focus:ring-amber-600">
                ...
                {formData.attendance === 'si' && (
                  <div className="bg-amber-50 p-6 rounded-lg space-y-4">
                    <h3 className="text-lg font-medium text-amber-800 mb-4">Detalles Adicionales</h3>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className="min-h-24 border-amber-300 focus:border-amber-600 focus:ring-amber-600"
                  />
                </div>
                ...
                <div className="pt-6">
                  <Button
                    ...
                    className="w-full h-14 bg-amber-800 hover:bg-amber-900 text-white text-lg font-medium tracking-wide transition-all duration-300"
                  >
                    {isSubmitting ? (
