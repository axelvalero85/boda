        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white/90 backdrop-blur-sm p-12 mb-12 shadow-lg border border-gray-300">
            ...
            <a
              ...
              className="inline-block px-10 py-4 border-2 text-lg font-medium tracking-wide uppercase transition-all duration-300"
              style={{ 
                borderColor: '#917955', 
                color: '#917955',
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {/* Venue Info - No rounded corners */}
            <div className="bg-white/90 backdrop-blur-sm shadow-lg p-8 border border-gray-300">
